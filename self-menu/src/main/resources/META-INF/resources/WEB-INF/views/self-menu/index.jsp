...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/wzt_self_menu/css/menu.css"/>
</head>
<body>
<div class="main-container">
    <div class="wechat-container">
        ...
        <div class="menus" id="menus">
            ...
            <div class="menu" v-if="subMenus.length &lt 3"
...
<script type="text/javascript" src="/wzt_self_menu/js/jquery.js"></script>
<script type="text/javascript" src="/wzt_self_menu/js/vue.js"></script>
<script type="text/javascript" src="/wzt_self_menu/js/menu.js"></script>
